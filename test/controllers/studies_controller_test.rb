...
class StudiesControllerTest < ActionController::TestCase
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post :create, study: { candidate_id: @study.candidate_id, study: @study.study, university: @study.university }
    end
  ...
  test "should update study" do
    patch :update, id: @study, study: { candidate_id: @study.candidate_id, study: @study.study, university: @study.university }
    assert_redirected_to study_path(assigns(:study))
  end
