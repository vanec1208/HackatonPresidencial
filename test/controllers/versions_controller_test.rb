...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { candidates: @version.candidates, questions: @version.questions, tips: @version.tips }
    end
  ...
  test "should update version" do
    patch :update, id: @version, version: { candidates: @version.candidates, questions: @version.questions, tips: @version.tips }
    assert_redirected_to version_path(assigns(:version))
  end
